...
def compose_test(notebook_path, output_path):
    context = _read_context("test_templates/context.py")
    runner = _read_context("test_templates/run.py")
...
def main():
    ...
    parser.add_argument('--notebook', type=str, default="fractal-compression.ipynb")
    parser.add_argument('--output', type=str, default="fractal-compression.py")
